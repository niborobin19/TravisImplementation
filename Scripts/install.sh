...
#  The below link will need to change depending on the version, this one is for 2020.3.12f1
#  Refer to https://unity3d.com/get-unity/download/archive and find the link pointed to by Mac "Unity Editor"
echo 'Downloading Unity 2020.3.12f1 pkg:'
curl --retry 5 -o Unity.pkg https://download.unity3d.com/download_unity/b3b2c6512326/MacEditorTargetInstaller/UnitySetup-Windows-Mono-Support-for-Editor-2020.3.12f1.pkg
...
echo 'Downloading Unity 2020.3.12f1 Windows Build Support pkg:'
curl --retry 5 -o Unity_win.pkg https://download.unity3d.com/download_unity/b3b2c6512326/MacEditorTargetInstaller/UnitySetup-Windows-Mono-Support-for-Editor-2020.3.12f1.pkg
if [ $? -ne 0 ]; then { echo "Download failed"; exit $?; } fi
