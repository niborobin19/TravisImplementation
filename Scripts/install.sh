...
curl --retry 5 -o Unity.pkg https://download.unity3d.com/download_unity/b3b2c6512326/MacEditorInstaller/Unity.pkg
...
curl --retry 5 -o UnitySetup-Windows-Mono-Support-for-Editor-2020.3.12f1.pkg https://download.unity3d.com/download_unity/b3b2c6512326/MacEditorTargetInstaller/UnitySetup-Windows-Mono-Support-for-Editor-2020.3.12f1.pkg
if [ $? -ne 0 ]; then { echo "Download failed"; exit $?; } fi

# Run installer(s)
echo 'Installing Unity.pkg'
sudo installer -dumplog -package Unity.pkg -target /
echo 'Installing UnitySetup-Windows-Mono-Support-for-Editor-2020.3.12f1.pkg.pkg'
sudo installer -dumplog -package UnitySetup-Windows-Mono-Support-for-Editor-2020.3.12f1.pkg -target /
